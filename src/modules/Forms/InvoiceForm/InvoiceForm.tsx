...
import { CustomerInfo, VehicleInfo, InvoiceProduct, InvoiceFormData, FormSettings } from '../types';
...
const InvoiceForm: React.FC<InvoiceFormProps> = ({
  ...
  const printForm = () => {
    ...
    printWindow.document.write(`
      ...
      <html>
        <head>
          <title>Fatura - ${formData.invoiceNumber}</title>
          <style>
            body {
  ...
  const calculateSummary = () => {
    ...
    formData.products.forEach(product => {
      ...
      // Fatura toplamı = Mal/Hizmet Tutarı - İskonto + KDV
  ...
  return (
    <div className="invoice-overlay">
      <div className="invoice-container">
        ...
        <div className="invoice-preview" ref={formRef}>
          ...
          {formData.vehicleInfo.brand && (
            <div className="info-box" style={{ marginBottom: '20px' }}>
              ...
              {formData.vehicleInfo.vin && (
                <div className="info-row">
                  <div className="info-label">Şasi No:</div>
                  <div className="info-value">{formData.vehicleInfo.vin}</div>
                </div>
              )}
            </div>
          )}
            ...
            <table className="products-table">
              <thead>
                <tr>
                  ...
                  {formData.settings.showVAT && <th style={{ width: '8%' }}>KDV %</th>}
                ...
                {formData.products.map((product, index) => {
                  ...
                  return (
                    <tr key={product.id}>
                      ...
                      {formData.settings.showTotalPrice && <td>{formatCurrency(priceAfterDiscount + taxAmount)} ₺</td>}
                    </tr>
                  );
                })}
              </tbody>
